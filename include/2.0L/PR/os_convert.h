...
#ifndef __MWERKS__
#define OS_K0_TO_PHYSICAL(x) (BKA_Reverse_Addr(BKA_TRANSLATE_ADDR(x)))
#define OS_K1_TO_PHYSICAL(x) (BKA_Reverse_Addr(BKA_TRANSLATE_ADDR(x)))
#else
#define OS_K0_TO_PHYSICAL(x) (BKA_Reverse_Addr(BKA_TRANSLATE_ADDR(x)))
#define OS_K1_TO_PHYSICAL(x) (BKA_Reverse_Addr(BKA_TRANSLATE_ADDR(x)))
#endif

#define OS_PHYSICAL_TO_K0(x) (BKA_TRANSLATE_ADDR(x))
#define OS_PHYSICAL_TO_K1(x) (BKA_TRANSLATE_ADDR(x))
