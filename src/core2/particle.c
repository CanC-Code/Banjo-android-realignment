...
ParticleEmitter * particleEmitter_new(u32 capacity){
    ParticleEmitter *this = n64_malloc(capacity*sizeof(Particle) + sizeof(ParticleEmitter));
    f32 sp40[3];
    ...
    if(partEmitMgrEnable){
        for(particle = this->pList_start_124; particle < this->pList_end_128;){//L802F005C
            ...
            if(particle->lifetime_4C <= particle->age_48){
                n64_memcpy(particle, --this->pList_end_128, sizeof(Particle));
            }else{//L802F00A0
...
void partEmitMgr_init(void){
    partEmitMgr = (ParticleEmitter **) n64_malloc(0);
    partEmitMgrLength = 0;
}
...
ParticleEmitter *partEmitMgr_newEmitter(u32 cnt){
    partEmitMgr = n64_realloc(partEmitMgr, (++partEmitMgrLength)*4);
...
void partEmitMgr_freeEmitter(ParticleEmitter *this){
    ...
    partEmitMgrLength--;
    partEmitMgr = n64_realloc(partEmitMgr, partEmitMgrLength*sizeof(ParticleEmitter *));
}
...
ParticleEmitter * partEmitMgr_defragEmitter(ParticleEmitter *this){
    ...
    if(this){
        ...
        this->pList_start_124 = (Particle *)((uintptr_t)this + (u32)((uintptr_t)this->pList_start_124 - a3));
        this->pList_end_128 = (Particle *)((uintptr_t)this + (u32)((uintptr_t)this->pList_end_128 - a3));
        this->pList_capacity_12C = (Particle *)((uintptr_t)this + (u32)((uintptr_t)this->pList_capacity_12C - a3));
        if(i < partEmitMgrLength){
            partEmitMgr[i] = this;
        }
