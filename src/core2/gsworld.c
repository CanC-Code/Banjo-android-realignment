...
void gsworld_draw(Gfx** gdl, Mtx **mptr, Vtx **vptr) {
    ...
    if (mapModel_has_xlu_bin() != 0) {
        ...
        if (game_is_frozen() == 0) func_80322E64(gdl, mptr, vptr);
        if (game_is_frozen() == 0) player_draw(gdl, mptr, vptr);
        if (game_is_frozen() == 0) func_80302C94(gdl, mptr, vptr);
        if (game_is_frozen() == 0) jiggylist_draw(gdl, mptr, vptr);
        if (game_is_frozen() == 0) func_803500D8(gdl, mptr, vptr);
        if (game_is_frozen() == 0) func_802F2ED0(func_8032994C(), gdl, mptr, vptr);
        if (game_is_frozen() == 0) partEmitMgr_drawPass0(gdl, mptr, vptr);
        if (game_is_frozen() == 0) mapModel_xlu_draw(gdl, mptr, vptr);
        if (game_is_frozen() == 0) func_8032D3D8(gdl, mptr, vptr);
        if (game_is_frozen() == 0) partEmitMgr_drawPass1(gdl, mptr, vptr);
        if (game_is_frozen() == 0) func_8034F6F0(gdl, mptr, vptr);
    ...
    if (game_is_frozen() == 0) func_80350818(gdl, mptr, vptr);
    if (game_is_frozen() == 0) func_802BBD0C(gdl, mptr, vptr);
    spawnQueue_lock();
}
